...
import { AdmissionHeadSidebar } from "../admission-head/AdmissionHeadSidebar";
import { AdmissionHeadHeader } from "./AdmissionHeadHeader";

export default function AdmissionHeadLayoutWrapper({
    children,
}: {
    ...
    return (
        <ProtectedRoute
            allowedRoles={["ADMISSION_HEAD"]}
            requireTenant={true}
        >
            <div className="flex h-screen overflow-hidden">
                <AdmissionHeadSidebar />
