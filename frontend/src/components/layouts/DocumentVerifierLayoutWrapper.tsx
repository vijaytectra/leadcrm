...
import { DocumentVerifierSidebar } from "./DocumentVerifierSidebar";
import { DocumentVerifierHeader } from "./DocumentVerifierHeader";

export default function DocumentVerifierLayoutWrapper({
    children,
}: {
    ...
    return (
        <ProtectedRoute
            allowedRoles={["DOCUMENT_VERIFIER", "INSTITUTION_ADMIN"]}
            requireTenant={true}
        >
            <div className="flex h-screen overflow-hidden">
                <DocumentVerifierSidebar />
                <div className="flex-1 flex flex-col overflow-hidden">
                    <DocumentVerifierHeader />
