...
import { FinanceTeamSidebar } from "./FinanceTeamSidebar";
import { FinanceTeamHeader } from "./FinanceTeamHeader";

export default function FinanceTeamLayoutWrapper({
    children,
}: {
    ...
    return (
        <ProtectedRoute
            allowedRoles={["FINANCE_TEAM", "INSTITUTION_ADMIN", "SUPER_ADMIN"]}
            requireTenant={true}
        >
