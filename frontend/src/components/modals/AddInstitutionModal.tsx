...
import { Building2, Mail, Phone, MapPin, CreditCard, Users, Sparkles, Star, Crown } from "lucide-react";
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <Input
                                                ...
                                                min="1"
                                                className="border-slate-300 text-black text-black focus:border-violet-400 focus:ring-violet-400/20 rounded-lg transition-all duration-200"
                                            />
